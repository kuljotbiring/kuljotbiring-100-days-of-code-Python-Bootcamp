"""
ou are going to write a program that adds to a travel_log. You can see a travel_log which is a List that contains 2
Dictionaries.
...
def add_new_country(location, num_visits, places):
    new_country = {}
