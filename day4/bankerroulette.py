...
When you run the code, just use a random number as the seed. e.g. 67346 It doesn't matter what you chose, it's only
for our testing code to check your work.
"""
import random
...
whose_paying = random.randint(0, last_index)

print(f"{names[whose_paying]} is going to buy the meal today!")